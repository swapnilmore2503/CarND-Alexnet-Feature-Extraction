...
fc8_W = tf.Variable(tf.truncated_normal(shape, mean = 0.0, stddev = 0.1))
fc8_b = tf.Variable(tf.truncated_normal([nb_classes], mean = 0.0, stddev = 0.1))
probs = tf.add(tf.matmul(fc7, fc8_W), fc8_b)
